        ...
        <?php if (!empty($button['link']) || $member_id) : ?>
          <div class="wrapper__btn start-screen__contacts-btn">
            <div class="btn start-screen-animate-js">
              <a href="<?= $member_id ? (get_permalink( $member_id ) . '#publications') : $button['link']; ?><?= ($is_other_projects_page_id ||is_singular( 'projects' )) ? '#completed' : (is_tax( 'services' ) ? '#services' : ''); ?>" class="btn__link">
